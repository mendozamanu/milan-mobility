...
for cl in classifier:
    ...
    for i in range(0, nfolds):
        ...
        X_train,y_train=readDataFromFile('./classif20x20week_internet10_iterative/'+s+str(i)+'.train')
        X_test,y_test=readDataFromFile('./classif20x20week_internet10_iterative/'+s+str(i)+'.test')
        classif = cl

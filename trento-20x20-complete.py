...
dfgg = scaled
dfgg['cellid']=cells
dfgg.to_csv('./results/tn_temp_2mon.csv')
...
dfsi2.to_csv("./results/tn/classif20x20month_smsin.csv")
dfso2.to_csv("./results/tn/classif20x20month_smsout.csv")
dfci2.to_csv("./results/tn/classif20x20month_callin.csv")
dfco2.to_csv("./results/tn/classif20x20month_callout.csv")
dfin2.to_csv("./results/tn/classif20x20month_internet.csv")
